												...
												<tr>
													...
													<td>
														<div class="form-button-action">
															...
															<button type="button"  onclick="window.location.href='<?= base_url('admin/jurusan/hapus/'.$c->kode_jurusan); ?>'" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="hapus">
