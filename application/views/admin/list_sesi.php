										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<form action="<?= base_url('admin/sesi/add');?>" method="POST">
														<div class="row">
															<div class="col-sm-12">
												...
												<tr>
													...
													<td>
														<div class="form-button-action">
															...
															<button type="button"  onclick="window.location.href='<?= base_url('admin/sesi/hapus/'.$c->kode_waktu); ?>'" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="hapus">
									...
									<div class="modal fade" id="edit<?= $c->kode_waktu?>" tabindex="-1" role="dialog" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<p class="small">Isi data dengan benar</p>
													<form action="<?= base_url('admin/sesi/update');?>" method="POST">
														<div class="row">
