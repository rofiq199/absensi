										...
										<tr>
											...
											<td>
												<div class="form-button-action">
													...
													<button type="button" onclick="window.location.href='<?= base_url('admin/DatapPodi/hapus/' . $c->kode_Prodi); ?>'" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="hapus">
										...
										<div class="modal fade" id="edit<?= $c->kode_prodi ?>" tabindex="-1" role="dialog" aria-hidden="true">
											<div class="modal-dialog" role="document">
												<div class="modal-content">
													...
													<div class="modal-body">
														<p class="small">Isi data Prodi dengan benar</p>
														<form action="<?= base_url('admin/fATS/update'); ?>" method="POST">
															<div class="row">
																<div class="col-sm-12">
																	<div class="form-group form-group-default">
																		<label>Kode Prodi</label>
