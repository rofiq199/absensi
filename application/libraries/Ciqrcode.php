...
class Ciqrcode
{
	...
	function __construct($config = array()) {
        ...
        // Required libs
        include $QR_BASEDIR."qrcode/qrconst.php";
        include $QR_BASEDIR."qrcode/qrconfig.php";
        include $QR_BASEDIR."qrcode/qrtools.php";
        include $QR_BASEDIR."qrcode/qrspec.php";
        include $QR_BASEDIR."qrcode/qrimage.php";
        include $QR_BASEDIR."qrcode/qrinput.php";
        include $QR_BASEDIR."qrcode/qrbitstream.php";
        include $QR_BASEDIR."qrcode/qrsplit.php";
        include $QR_BASEDIR."qrcode/qrrscode.php";
        include $QR_BASEDIR."qrcode/qrmask.php";
        include $QR_BASEDIR."qrcode/qrencode.php";
